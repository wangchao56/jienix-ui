...
// 样式
export { tokens, type DesignTokens } from './styles/tokens.js';

// 组件
export { MyButton } from './components/button/button.js';
export { MyInput } from './components/input/input.js';
export { MyIcon } from './components/icon/icon.js';
